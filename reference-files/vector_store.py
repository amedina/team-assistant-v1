...
class VectorStoreManager:
    ...
    def __init__(
        ...
        config_file: str = "data_sources_config.yaml",
    ):
        ...
        try:
            ...
            if self.vector_search_index == "psat-agent-vector-search":
                logger.warning("Using default Vector Search index - consider updating data_sources_config.yaml")
            if self.vector_search_index_endpoint == "psat-agent-vector-search-endpoint":
                logger.warning("Using default Vector Search endpoint - consider updating data_sources_config.yaml")
    ...
    def update_vector_store_config(
        ...
        Note: For consistency, consider updating data_sources_config.yaml instead
        ...
        if config_file:
            ...
            if vector_search_index or vector_search_index_endpoint or vector_search_bucket:
                logger.warning("Updating Vector Search config directly. Consider updating data_sources_config.yaml for consistency.")
